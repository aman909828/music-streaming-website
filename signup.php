            ...
            <div class="content">
                <form method="post">
                    ...
                    <div class="card">
                        ...
                        <input type="pasword" name="user_password" placeholder="Enter Your Password..." required>

                    </div>
                    <div class="card">
                        <label for="re-password">Re-Password</label>
                        <input type="pasword" name="user_re_password" placeholder="Enter Your Password again..." required>
